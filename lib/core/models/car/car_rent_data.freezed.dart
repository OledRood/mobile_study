...
mixin _$CarRentData {
 ...
 String get id; String get autoName; String get autoMark; String get pricePerDay;// исправлено с pircePerDay
 String get startRentDate; String get endRentDate; String get adress; String get priceOfInsurance; String get totalPrice; String get priceOfDeposit; String get image; String? get driverName; String? get driverLicenseNumber; String? get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,autoName,autoMark,pricePerDay,startRentDate,endRentDate,adress,priceOfInsurance,totalPrice,priceOfDeposit,image,driverName,driverLicenseNumber,status);

@override
String toString() {
  return 'CarRentData(id: $id, autoName: $autoName, autoMark: $autoMark, pricePerDay: $pricePerDay, startRentDate: $startRentDate, endRentDate: $endRentDate, adress: $adress, priceOfInsurance: $priceOfInsurance, totalPrice: $totalPrice, priceOfDeposit: $priceOfDeposit, image: $image, driverName: $driverName, driverLicenseNumber: $driverLicenseNumber, status: $status)';
}
...
@useResult
$Res call({
 String id, String autoName, String autoMark, String pricePerDay, String startRentDate, String endRentDate, String adress, String priceOfInsurance, String totalPrice, String priceOfDeposit, String image, String? driverName, String? driverLicenseNumber, String? status
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String autoName,  String autoMark,  String pricePerDay,  String startRentDate,  String endRentDate,  String adress,  String priceOfInsurance,  String totalPrice,  String priceOfDeposit,  String image,  String? driverName,  String? driverLicenseNumber,  String? status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CarRentData() when $default != null:
return $default(_that.id,_that.autoName,_that.autoMark,_that.pricePerDay,_that.startRentDate,_that.endRentDate,_that.adress,_that.priceOfInsurance,_that.totalPrice,_that.priceOfDeposit,_that.image,_that.driverName,_that.driverLicenseNumber,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String autoName,  String autoMark,  String pricePerDay,  String startRentDate,  String endRentDate,  String adress,  String priceOfInsurance,  String totalPrice,  String priceOfDeposit,  String image,  String? driverName,  String? driverLicenseNumber,  String? status)  $default,) {final _that = this;
switch (_that) {
case _CarRentData():
return $default(_that.id,_that.autoName,_that.autoMark,_that.pricePerDay,_that.startRentDate,_that.endRentDate,_that.adress,_that.priceOfInsurance,_that.totalPrice,_that.priceOfDeposit,_that.image,_that.driverName,_that.driverLicenseNumber,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String autoName,  String autoMark,  String pricePerDay,  String startRentDate,  String endRentDate,  String adress,  String priceOfInsurance,  String totalPrice,  String priceOfDeposit,  String image,  String? driverName,  String? driverLicenseNumber,  String? status)?  $default,) {final _that = this;
switch (_that) {
case _CarRentData() when $default != null:
return $default(_that.id,_that.autoName,_that.autoMark,_that.pricePerDay,_that.startRentDate,_that.endRentDate,_that.adress,_that.priceOfInsurance,_that.totalPrice,_that.priceOfDeposit,_that.image,_that.driverName,_that.driverLicenseNumber,_that.status);case _:
  return null;
