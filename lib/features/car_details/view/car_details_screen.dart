        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              _LeftPaddingWidget(child: Text(state.carDetails?.name ?? "")),
              Divider(),
              _LeftPaddingWidget(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Адрес нахождения:"),
                    Row(
                      children: [
                        Icon(Icons.location_on),
                        Text(state.carDetails?.location ?? ""),
                      ],
                    ),
                  ],
                ),
              ...
              _LeftPaddingWidget(
                child: Column(
                  ...
                  children: [
                    Text("Описание"),
                    Text(state.carDetails?.description ?? ""),
                  ],
                ),
              ),
            ],
...
class _BottomButtonContainer extends StatelessWidget {
  ...
  const _BottomButtonContainer({super.key, required this.pricePerDay});
    ...
    return Container(
      ...
      child: Row(
        children: [
          Text(pricePerDay),
          Spacer(),
          FilledButton(onPressed: () {}, child: Text("Забронировать")),
        ],
      ),
    );
  }
