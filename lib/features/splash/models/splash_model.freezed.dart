...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashModel&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading));
}
...
@override
String toString() {
  return 'SplashModel(isLoading: $isLoading)';
}
...
class _SplashModel implements SplashModel {
  const _SplashModel({this.isLoading = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SplashModel&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading));
}
