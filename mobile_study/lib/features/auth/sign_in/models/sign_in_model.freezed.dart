...
mixin _$SignInState {
 ...
 bool get isLoading; String? get emailError; String? get passwordError; bool get isPasswordVisible;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,emailError,passwordError,isPasswordVisible);

@override
String toString() {
  return 'SignInState(isLoading: $isLoading, emailError: $emailError, passwordError: $passwordError, isPasswordVisible: $isPasswordVisible)';
}
...
@useResult
$Res call({
 bool isLoading, String? emailError, String? passwordError, bool isPasswordVisible
});
...
/// Create a copy of SignInState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? emailError = freezed,Object? passwordError = freezed,Object? isPasswordVisible = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  String? emailError,  String? passwordError,  bool isPasswordVisible)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignInState() when $default != null:
return $default(_that.isLoading,_that.emailError,_that.passwordError,_that.isPasswordVisible);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  String? emailError,  String? passwordError,  bool isPasswordVisible)  $default,) {final _that = this;
switch (_that) {
case _SignInState():
return $default(_that.isLoading,_that.emailError,_that.passwordError,_that.isPasswordVisible);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  String? emailError,  String? passwordError,  bool isPasswordVisible)?  $default,) {final _that = this;
switch (_that) {
case _SignInState() when $default != null:
return $default(_that.isLoading,_that.emailError,_that.passwordError,_that.isPasswordVisible);case _:
  return null;
...
class _SignInState implements SignInState {
  const _SignInState({this.isLoading = false, this.emailError, this.passwordError, this.isPasswordVisible = false});
...
/// Create a copy of SignInState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? emailError = freezed,Object? passwordError = freezed,Object? isPasswordVisible = null,}) {
