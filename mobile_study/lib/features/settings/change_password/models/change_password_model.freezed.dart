...
@override
String toString() {
  return 'ChangePasswordState(emailError: $emailError, passwordError: $passwordError, confirmPasswordError: $confirmPasswordError, isPasswordVisible: $isPasswordVisible, isConfirmPasswordVisible: $isConfirmPasswordVisible, isLoading: $isLoading)';
}
...
class _CreateNewPasswordState extends ChangePasswordState {
...
/// @nodoc
abstract mixin class _$CreateNewPasswordStateCopyWith<$Res> implements $ChangePasswordStateCopyWith<$Res> {
