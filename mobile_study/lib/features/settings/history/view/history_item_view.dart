...
class HistoryItemScreen extends StatelessWidget {
  const HistoryItemScreen({super.key});
...
// class HistoryItemScreen extends ConsumerWidget {
//   final String carId;
//   const HistoryItemScreen({super.key, required this.carId});
...
//       return Scaffold(
//         appBar: AppBar(title: Text("Бронирование #$carId")),
//         body: Center(child: CircularProgressIndicator()),
//       );
//     }
//     final carRentData = state.historyData!;
//     return Scaffold(
