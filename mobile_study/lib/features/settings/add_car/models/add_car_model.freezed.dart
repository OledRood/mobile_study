...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddCarState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading));
}
...
@override
String toString() {
  return 'AddCarState(isLoading: $isLoading)';
}
...
class _AddCarState implements AddCarState {
  const _AddCarState({this.isLoading = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AddCarState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading));
}
